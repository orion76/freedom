...
use Drupal\rate\Plugin\RateWidgetManagerInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Form controller for vote type forms.
 */
class RateWidgetConfigForm extends EntityForm {
  ...
  /** @var RateWidgetManagerInterface */
  ...
  public function __construct(EntityTypeManagerInterface $entity_manager,
                              ...
                              RateWidgetManagerInterface $widget_manager,
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('plugin.manager.rate_widget'),
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $template_list = [];
    foreach ($this->widgetManager->getDefinitions() as $pluginDefinition) {
      $plugin = $this->widgetManager->createInstance($pluginDefinition['id']);
      $template_list[$plugin->get('id')] = $plugin->get('label');
    }
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => ['Drupal\rate\Entity\RateWidgetConfig', 'load'],
        'source' => ['label'],
      ],
    ...
    if ($this->operation == 'edit') {
      $url = Url::fromRoute('entity.rate_widget.template_form', ['rate_widget_config' => $this->entity->id()])->toString();
