...
use Drupal\rate\RateWidgetConfigInterface;

/**
 * Defines the Rate Widget configuration entity.
 *
 * @ConfigEntityType(
 *   id = "rate_widget_config",
 *   label = @Translation("Rate widget"),
 *   config_prefix = "rate_widget_config",
 *   handlers = {
 *     "form" = {
 *       "add" = "Drupal\rate\Form\RateWidgetConfigForm",
 *       "edit" = "Drupal\rate\Form\RateWidgetConfigForm",
 *       "delete" = "Drupal\rate\Form\RateWidgetConfigDeleteForm",
 *       "template" = "Drupal\rate\Form\RateWidgetConfigForm",
 *     },
 *     "list_builder" = "Drupal\rate\RateWidgetConfigListBuilder",
 *   },
 ...
 * )
 */
class RateWidgetConfig extends ConfigEntityBase implements RateWidgetConfigInterface {
