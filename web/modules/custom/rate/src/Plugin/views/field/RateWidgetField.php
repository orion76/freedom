...
class RateWidgetField extends FieldPluginBase {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $widgets = \Drupal::service('entity_type.manager')->getStorage('rate_widget_config')->loadMultiple();
    $entity_types = [];
    $widget_count = 0;
  ...
  public function render(ResultRow $row) {
    ...
    $widget_storage = \Drupal::service('entity_type.manager')->getStorage('rate_widget_config');
//    $rate_widget_base_service = \Drupal::service('rate.vote_widget_base');
    ...
    if (!isset($entity_id) || !isset($entity_type_id) || !isset($bundle)) {
      ...
      $query = \Drupal::entityQuery('rate_widget_config');
